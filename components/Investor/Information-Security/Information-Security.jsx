                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        {[
                            ...
                            >
                                ...
                                <motion.h3
                                    ...
                                    className="mt-8 text-2xl font-bold text-[#00314A]"
                                >
                                    {item.title}
                                </motion.h3>
                    ...
                    >
                        ...
                        <motion.div
                            ...
                            className="inline-flex items-center gap-2 rounded-full border border-[#EAF9FA]/20 bg-[#EAF9FA]/10 px-4 py-2 text-sm font-medium text-[#00314A]"
                        >
                            <Landmark size={16} />
                        ...
                        <motion.h2
                            ...
                            className="mt-6 text-3xl sm:text-4xl lg:text-5xl font-bold leading-tight text-[#00314A]"
                        >
                            ...
                            {[
                                ...
                                >
                                    ...
                                    <motion.div
                                        ...
                                        className="absolute top-0 right-0 w-32 h-32 bg-[#EAF9FA]/10 blur-3xl rounded-full"
                                    />
                                    ...
                                    <div className="relative z-10">
                                        <motion.h3
                                            ...
                                            viewport={{ once: false, amount: 0.3 }}
                                            transition={{ delay: 0.3 + idx * 0.1, duration: 0.6 }}
                                            className="mt-6 text-3xl sm:text-3xl lg:text-3xl font-bold leading-tight text-[#00314A]"
                                        >
                                            {item.title}
                                        </motion.h3>
