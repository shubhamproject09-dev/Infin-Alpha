...
export default function WhyAIFSection() {
    ...
    return (
        <section className="relative overflow-hidden py-24 lg:py-32 bg-[#030712]">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                <div className="grid lg:grid-cols-12 gap-16 items-center">
                    ...
                    <div className="lg:col-span-5" >
                        ...
                        <span className="inline-flex items-center px-4 py-2 rounded-full bg-green-500/10 border border-green-500/20 text-green-300 text-sm font-medium backdrop-blur-md">
                ...
                <div className="mt-24 relative">
                    ...
                    <div className="absolute left-5 top-0 bottom-0 w-px bg-gradient-to-b from-green-500 via-green-400/50 to-transparent"></div>
                        ...
                        {points.map((item, index) => (
                            ...
                            >
                                ...
                                <div className="lg:col-span-2 relative">
                                    ...
                                    <div className="relative z-10 w-11 h-11 rounded-full bg-gradient-to-br from-green-500 to-emerald-600 text-white flex items-center justify-center shadow-[0_0_25px_rgba(34,197,94,0.35)] group-hover:scale-110 transition duration-300">
                                ...
                                <div className="lg:col-span-10">
                                    ...
                                    <div className="relative overflow-hidden border border-white/10 bg-white/[0.03] backdrop-blur-xl rounded-[32px] p-8 lg:p-10 hover:border-green-500/30 transition-all duration-500">

                                        {/* Hover Glow */}
                                        <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition duration-500 bg-gradient-to-r from-green-500/5 via-transparent to-emerald-500/5"></div>
                ...
                <div className="mt-28">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        {/* CARD 1 */}
                        <div className="relative overflow-hidden rounded-[32px] border border-green-500/20 bg-gradient-to-br from-green-500/10 to-emerald-500/5 p-10 backdrop-blur-xl">

                            <div className="absolute top-0 right-0 w-40 h-40 bg-green-500/10 blur-3xl rounded-full"></div>

                            <div className="relative z-10">

                                <h3 className="text-3xl lg:text-3xl font-bold text-green-400">
                                    ₹15L+
                                </h3>
