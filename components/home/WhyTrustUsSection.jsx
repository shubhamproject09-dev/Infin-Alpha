...
export default function WhyTrustUsSection() {
    ...
    return (
        <section className="relative overflow-hidden py-20 sm:py-24 lg:py-32">
            ...
            {/* DARK OVERLAY */}
            <div className="absolute inset-0 bg-[#00314A]/95"></div>

            {/* GREEN GLOW */}
            <div className="absolute top-0 left-0 w-[500px] h-[500px] bg-[#009A9E]/10 blur-3xl rounded-full"></div>
                        ...
                        >
                            ...
                            {[...trustPoints, ...trustPoints, ...trustPoints].map((item, index) => (
                                ...
                                >
                                    ...
                                    {/* Glow */}
                                    <div className="absolute top-0 right-0 w-40 h-40 bg-[#009A9E]/10 blur-3xl rounded-full opacity-0 group-hover:opacity-100 transition duration-500"></div>
                                    ...
                                    <div className="relative z-10">
                                        ...
                                        {/* Icon */}
                                        <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-[#009A9E] to-[#00314A] text-white flex items-center justify-center shadow-xl shadow-[#009A9E]/20">
                                    ...
                                    {/* Bottom Line */}
                                    <div className="relative z-10 mt-10 w-full h-px bg-gradient-to-r from-[#009A9E]/40 to-transparent"></div>
