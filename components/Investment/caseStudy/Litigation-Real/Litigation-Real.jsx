...
export default function LitigationRealEstatePage() {
    return (
                ...
                <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="max-w-5xl mx-auto text-center">
                        ...
                        <p className="mt-8 max-w-4xl mx-auto text-base sm:text-lg lg:text-xl leading-9 text-slate-300">
                            ...
                            Unlocking trapped value across litigation-linked
                            real estate opportunities through strategic
                            restructuring, phased capital deployment,
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid md:grid-cols-3 gap-6">
                        ...
                        {[
                            ...
                            {
                                title: "19% IRR",
                                subtitle: "Target Return Potential",
                            },
                            {
                                title: "Phased",
                    ...
                    <div className="mt-20 grid lg:grid-cols-2 gap-10">
                        ...
                        <div className="rounded-[36px] border border-slate-200 p-8 shadow-sm">
                            ...
                            <p className="mt-6 text-base leading-9 text-slate-700" style={{ color: "#000000" }}>
                                ...
                                Litigation-linked real estate opportunities
                                often contain significant trapped value
                                requiring structured legal,
                                operational,
                        ...
                        <div className="rounded-[36px] border border-slate-200 p-8 shadow-sm">
                            ...
                            <p className="mt-6 text-base leading-9 text-slate-700" style={{ color: "#000000" }}>
                                ...
                                Strategic legal coordination,
                                phased funding structures,
                                and institutional negotiations
                                support value unlocking
                                and project revitalization.
